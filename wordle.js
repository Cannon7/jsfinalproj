const words500 = [
    ...
    "occur","ended","chord","false","skill","holes","dozen","brave","apple","climb","outer","pitch","ruler","holds","fixed","costs","calls","blank","staff","labor","eaten","youth","tones","honor","globe","gases","doors","poles","loose","apply","tears","exact","brush","chest","layer","whale","minor","faith","tests","judge","items","worry","waste","hoped","strip","begun","aside","lakes","bound","depth","candy","event","worse","aware","shell","rooms","ranch","image","snake","aloud","dried","likes","motor","pound","knees","refer","fully","chain","shirt","flour","drops","spite","orbit","banks","shoot","curve","tribe","tight","blind","slept","shade","claim","flies","theme","queen","fifth","union","hence","straw","entry","issue","birth","feels","anger","brief","rhyme","glory","guard","flows","flesh","owned","phone"
    ]


//--------------------CODE START-------------------------------------------------------------------------
var solutionletters = words500[getRandomInt(500)].split("");
...
function guessget()
{
    ...
    if (guesscount != 7)
    {
        ...
        wordletters.forEach(element => {
            var displayguess = document.getElementById("guess" + guesscount + "" + licount);
            displayguess.innerHTML = element;
            displayguess.style.backgroundColor = factcheck(element, licount, solutionletters);
            licount = licount + 1;
        });
        guesscount += 1;
    }
    ...
    {
        const titletext = document.getElementById("gridtitle");
        titletext.innerHTML = "game over, the word was " + solutionletters;
    }
    document.getElementById("Guess").value = "";
}
function factcheck(element, licount, solutionletters)
{
     var color = "grey";
     if (solutionletters.includes(element))
     {
         color = "yellow";
     }
     if (solutionletters[licount] == element)
     {
         color = "green";
     }
     return color;
